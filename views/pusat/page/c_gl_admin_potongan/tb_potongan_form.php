...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tb_potongan <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="ket_potongan">Ket Potongan <?php echo form_error('ket_potongan') ?></label>
            <textarea class="form-control" rows="3" name="ket_potongan" id="ket_potongan" placeholder="Ket Potongan"><?php echo $ket_potongan; ?></textarea>
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('c_gl_admin_potongan') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>