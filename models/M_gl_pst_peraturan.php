<?php
	class M_gl_pst_peraturan extends CI_Model 
	{
		...
		function kode_peraturan($kode_kantor)
		{
			$data = $this->db->query("
				SELECT CONCAT('PR',FRMTGL,ORD) AS kode_per
				From
				(
					...
					(
						...
						MID(NOW(),9,2) AS D,
						COALESCE(MAX(CAST(RIGHT(kode_per,5) AS UNSIGNED)) + 1,1) AS ORD
						From tb_peraturan
