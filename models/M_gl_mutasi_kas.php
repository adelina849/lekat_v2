	...
	class M_gl_mutasi_kas extends CI_Model 
	{
		...
		function list_mutasi_kas_limit($cari,$order_by,$limit,$offset)
		{
			$query = "
				...
				LEFT JOIN tb_kode_akun AS C ON A.kode_kantor = C.kode_kantor AND A.id_kode_out = C.id_kode_akun
				".$cari."
				".$order_by."
				LIMIT ".$offset.",".$limit."
			";
		...
		function hapus($berdasarkan,$id_mutasi,$kode_kantor)
		{
			/*HAPUS JABATAN*/
				$strquery = "DELETE FROM tb_mutasi_kas WHERE ".$berdasarkan." = '".$id_mutasi."' AND kode_kantor = '".$kode_kantor."' ;";
			/*HAPUS JABATAN*/
