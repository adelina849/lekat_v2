<?php
	class M_gl_pst_lap_pembelian extends CI_Model 
	{
		...
		function list_pemesanan_dari_cabang_lain($cari,$order_by,$limit,$offset)
		{
			...
			"
				...
				LEFT JOIN tb_h_penjualan AS F ON B.no_h_pembelian = F.ket_penjualan AND F.kode_kantor = '".$this->session->userdata('ses_kode_kantor')."' AND F.sts_penjualan = 'SELESAI'
				".$cari."
				".$order_by."
				LIMIT ".$offset.",".$limit."
			";
