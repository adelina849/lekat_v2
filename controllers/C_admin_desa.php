...
class C_admin_desa extends CI_Controller {
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				if(!empty($data_kecamatan))
				{
					...
					$data = array('page_content'=>'ptn_admin_desa','halaman'=>$halaman,'data_kecamatan' => $data_kecamatan,'list_desa'=>$list_desa);
	...
	public function simpan()
	{
		...
		if (!empty($_POST['stat_edit']))
		{
			...
			header('Location: '.base_url().'kecamatan-desa/'.$_POST['KEC_ID']);
		}
		else
		{
	...
	public function hapus()
	{
		...
		header('Location: '.base_url().'kecamatan-desa/'.$kec_id);
	}
}
