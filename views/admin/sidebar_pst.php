				...
				<li id="2_basis_data" class="treeview">
				  ...
				  <ul class="treeview-menu">
						...
						<li id="23_basis_data_pasien">
						  <a href="#"><i class="fa fa-folder"></i> Customer/Cabang <i class="fa fa-angle-left pull-right"></i></a>
						  <ul class="treeview-menu">
								...
								{
								?>
								<li id="232_basis_data_pasien_pasien"><a href="<?=base_url()?>gl-admin-pasien"><i class="fa fa-edit"></i> Data Customer/Cabang </a></li>
			...
			<!-- CEK AKSES LEVEL 1 MAIN 4 PENGATURAN OPERASIONAL -->
				...
				<li class="treeview" id="4_pengaturan_Operasional">
				  ...
				  <ul class="treeview-menu">
						...
						{
						?>
						<li id="43_pengaturan_Operasional_hargaPasien"><a href="<?php echo base_url();?>gl-admin-harga-pasien"><i class="fa fa-circle-o"></i> Harga Jual </a></li>
						<?php
						}
						?>
			...
			<!-- CEK AKSES LEVEL 1 MAIN 5 TRANSAKSI -->
				...
				<li class="treeview" id="5_transaksi">
				  ...
				  <ul class="treeview-menu">
						...
						{
						?>
						<li id="513_transaksi_pembayaran"><a href="<?=base_url()?>gl-admin-penjualan-langsung"><i class="fa fa-money"></i><span> <font style="color:red;">1.</font> Penjualan </a></li>
						<?php
						}
						?>
						...
						<li id="53_transaksi_pemeriksaan">
							<a href="<?=base_url()?>gl-admin-pemeriksaan-dokter">
								...
								<span><font style="color:red;">2.</font> List Transaksi</span>
								<span class="pull-right-container">
						...
						<li id="511_transaksi_jurnal_umum"><a href="<?=base_url()?>gl-pusat-admin-jurnal-umum-pembalik"><i class="fa fa-file-word-o"></i> Jurnal Umum						
						</a></li>
						...
						{
						?>
						<li id="510_transaksi_Pemakaian"><a href="<?=base_url()?>gl-admin-mutasi-out"><i class="fa fa-minus-square"></i> Pemakainan/Mutasi Out						
						</a></li>
						<?php
						}
						?>
						...
						{
						?>
						<li id="511_transaksi_Penambahan"><a href="<?=base_url()?>gl-admin-mutasi-in"><i class="fa fa-plus-square"></i> Penambahan/Mutasi In						
						</a></li>
						<?php
						}
						?>
				...
				?>
					<li class="treeview" id="7_laporan">
					  ...
					  <ul class="treeview-menu">
									...
									{
										if(
											($page_content <> 'gl_admin_h_penjualan_proses_dokter_proses') && ($page_content <> 'gl_admin_stock_produk') 
											...
											&& ($page_content <> 'gl_admin_stock_produk_per_supplier')
											&& ($page_content <> 'gl_admin_stock_produk_per_kategori')
									...
									<?php
									if( ($this->session->userdata('ses_akses_lvl3_7112') > 0) or ($this->session->userdata('ses_nama_jabatan') == 'Admin Aplikasi') )
									{
									?>
									
									<li id="713_laporan_general_retur"><a href="<?=base_url()?>gl-admin-laporan-retur"><i class="fa fa-edit"></i> Retur/Pengembalian </a></li>
									...
									<li id="7110_laporan_general_apoteker">
										<a href="<?=base_url()?>gl-admin-laporan-apoteker">
											<span><i class="fa fa-edit"></i>  Cek List Produk </span>
											<span class="pull-right-container">
									...
									<!-- PENGECUALIAAN UNTUK PUSAT SAJA, JADI JURNAL DIPINDAHKAN KELAPORAN -->
									<?php
				...
				?>
					...
					<li id="8_statistik" class="treeview">
					  ...
					  <ul class="treeview-menu">
							...
							<li id="82_statistik_pasien"><a href="<?=base_url()?>gl-admin-statistik-penjualan-pelanggan"><i class="fa fa-user"></i> Pelanggan </a></li>
							...
							<li id="83_statistik_produk"><a href="<?=base_url()?>gl-admin-statistik-penjualan-produk"><i class="fa fa-cart-plus"></i> Produk </a></li>
