...
class C_admin_akum_laporan extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				$data = array('page_content'=>'ptn_admin_akum_laporan','list_klaporan'=>$list_klaporan,'cari' => $cari);
	...
	function akumulasi_periode()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				{
					header('Location: '.base_url().'akumulasi-laporan-kecamatan');
				}
			}
			else
			{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				if(!empty($data_laporan))
				{
					...
					$data = array('page_content'=>'ptn_admin_akum_detail_laporan','data_laporan'=>$data_laporan,'jum_kecamatan'=>$jum_kecamatan,'jum_periode' => $jum_periode,'data_item_laporan' => $data_item_laporan,'jum_col' => $jum_col);
					$this->load->view('admin/container',$data);
